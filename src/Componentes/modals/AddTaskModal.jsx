  ...
  return (
    ...
    -translate-y-1/2 shadow-xl shadow-black/30 p-6 rounded-2xl flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-4">
        <Input nameField="taskTitle" changeEvent={onInformationChange}>What's the task name?</Input>
        <TextArea fieldName="taskDescription" changeEvent={onInformationChange} />
      </div>
